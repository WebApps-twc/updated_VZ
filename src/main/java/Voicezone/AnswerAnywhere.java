...
//	  TN=TN+lastfour;
  ...
  public String TNcheck(String br,String ac, String midtn, String lastfour, String check,WebDriver driver) throws Exception
  {
	  ...
	  driver.findElement(By.id("txtAreaCode")).clear();
	    ...
	    driver.findElement(By.xpath("//html/body/div[3]/form/div/div[3]/div[2]/div/div/div/div/div[3]/div/div[2]/p/span[2]/a")).click();
	    driver.manage().timeouts().implicitlyWait(40, TimeUnit.SECONDS);
	      
	      if(driver.findElements(By.xpath("//html/body/div[4]")).size()!=0)
	      {
	             Thread.sleep(2000);
	      ...
	      focusClick(driver, driver.findElement(By.xpath("//*[@id='friendlyNameDialog']/div[3]/button")),br);
	      Thread.sleep(3000);
	  ...
	  count=driver.findElements(By.xpath("//html/body/div[3]/form/div/div[3]/div[2]/div/div/div/div/div[3]/div/div[4]/table/tbody/tr")).size();
	  System.out.println(count);
	  if(isElementPresent(driver,By.xpath("//*[@id='ValidationBlock']/div/span")) && count==limit)
	  {
