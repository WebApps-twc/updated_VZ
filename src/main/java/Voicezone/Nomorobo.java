...
public class Nomorobo extends CommonFunctions {
    ...
    public ArrayList<String> CheckAAStatus( String br,WebDriver driver) throws Exception
    {
    	ArrayList<String> str = new ArrayList<String>();
    	 ...
    	 NMVal= driver.findElement(By.xpath("//*[@id='ContentRefresh']/div/div[3]/div[1]/ul/li[4]/p/span[1]")).getAttribute("class");
	      System.out.println("NomoRobo status "+NMVal);
	      AAVal= driver.findElement(By.xpath("//*[@id='ContentRefresh']/div/div[4]/div[1]/ul/li[1]/p/span")).getAttribute("class");
